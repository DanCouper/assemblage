defmodule Assemblage.ArticlesTest do
  use Assemblage.DataCase

  alias Assemblage.Articles

  describe "posts" do
    alias Assemblage.Articles.Post

    @valid_attrs %{body: %{}, description: "some description", title: "some title"}
    @update_attrs %{body: %{}, description: "some updated description", title: "some updated title"}
