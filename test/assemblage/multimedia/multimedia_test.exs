defmodule Assemblage.MultimediaTest do
  ...
  describe "images" do
    ...
    @valid_attrs %{description: "some description", full_src: "some full_src", title: "some title"}
    ...
    test "create_image/1 with valid data creates a image" do
      ...
      assert image.full_src == "some full_src"
    ...
    test "update_image/2 with valid data updates the image" do
      ...
      assert image.full_src == "some updated full_src"
