defmodule AssemblageWeb.ImageControllerTest do
  use AssemblageWeb.ConnCase

  alias Assemblage.Multimedia

  @create_attrs %{description: "some description", full_src: "some full_src", title: "some title"}
  @update_attrs %{description: "some updated description", full_src: "some updated full_src", title: "some updated title"}
  @invalid_attrs %{description: nil, full_src: nil, title: nil}

  def fixture(:image) do
    {:ok, image} = Multimedia.create_image(@create_attrs)
    image
  end
